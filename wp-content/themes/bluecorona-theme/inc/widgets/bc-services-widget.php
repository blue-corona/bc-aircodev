...
<?php 
	if ( isset( $instance['title'] ) && !empty($instance['title']) ) {
		...
		echo '<h2 class="text-center m-0 bc_alternate_font_blue text-capitalize">Our</h2>';
...
<?php echo $args['after_widget'];
	...
	public function form( $instance ) {
		...
		$title = '<h2 class="text-center m-0 bc_alternate_font_blue text-capitalize">'.__( 'Our', 'bc-service-custom-widget' ).'</h2>'.'<h3 class="text-center mb-3 bc_primary_content_blue"><strong>'.__( 'SERVICES', 'bc-service-custom-widget' ).'</strong></h3>';
		if ( isset( $instance['title'] ) && ! empty( $instance['title'] ) ) {
